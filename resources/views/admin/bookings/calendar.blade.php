...
<!-- FullCalendar (free), Bootstrap tooltips assumed available from your layout -->
<link href="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.11/main.min.css" rel="stylesheet" />
<script src="https://cdn.jsdelivr.net/npm/fullcalendar@6.1.11/main.min.js"></script>

<style>
/* optional styling for day bias */
.fc-daycare-heavy .fc-event-main { background: rgba(17, 138, 178, 0.12) !important; }
.fc-boarding-heavy .fc-event-main { background: rgba(40,167,69,0.12) !important; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        // point to the route that returns aggregated JSON
        events: "{{ route('admin.bookings.calendar.data') }}",
        eventClick: function(info) {
            // event.startStr is the YYYY-MM-DD date string
        ...
        eventDidMount: function(info) {
            // small tooltip showing counts quickly
