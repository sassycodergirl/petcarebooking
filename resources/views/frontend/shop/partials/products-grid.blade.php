                                ...
                                <div class="product-card-col h-100 shadow-sm p-2 p-md-4">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="">
                                            ...
                                            <button class="add-to-bag cd-button" data-id="{{ $product->id }}"  data-name="{{ $product->name }}"  data-price="{{ $product->price }}" data-image="{{ asset('public/' . $product->image) }}"><img class="d-none d-md-block" src="{{ asset('images/bag-icon.svg') }}" alt=""> Add gggg to Cart</button>
                                        </div>
