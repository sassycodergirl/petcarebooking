                        ...
                        <div class="stepform-body row">
                            ...
                            <div class="col-md-8" id="reviewLeft">
                                <div class="review-section">
                                    <div class="booking-details-div bg-white p-3 p-md-5 box-shadow">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                <h5><strong>Location:</strong></h5> <div id="reviewLocation"></div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                 <h5><strong>Booking Type:</strong> </h5><div id="reviewBookingType"></div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                 <h5><strong>Check In Date & Time:</strong> </h5><div id="reviewCheckInDateTime"></div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                 <h5><strong>Checo Out Date & Time:</strong></h5><div id="reviewCheckOutDateTime"></div>
                                            </div>
                                    ...
                                    <div class="pet-details-div bg-white p-3 p-md-5 box-shadow">
                                        <h4>Pet Details</h4>
